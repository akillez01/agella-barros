...
const DEFAULT_STATE = {
  ...
  gallery: [
    { id: 'g11', src: 'assets/imgs/Captura de tela de 2026-08-15 14-45-29.png', caption: 'Estética corporal com massagens e serviços', cat: 'Massoterapia' },
    { id: 'g12', src: 'assets/imgs/Captura de tela de 2026-08-15 14-46-15.png', caption: 'Epilação com cera e combos especiais', cat: 'Massoterapia' },
    { id: 'g6', src: 'assets/imgs/WhatsApp Image 2026-08-15 at 13.47.19.jpeg', caption: 'Procedimentos e valores', cat: 'Serviços & Valores' },
    { id: 'g5', src: 'assets/imgs/WhatsApp Image 2026-08-15 at 13.47.18.jpeg', caption: 'Agenda aberta - agosto', cat: 'Promoções' },
    { id: 'g8', src: 'assets/imgs/WhatsApp Image3 2026-08-15 at 13.47.19.jpeg', caption: 'Serviços a partir de R$ 100,00 + brinde surpresa', cat: 'Promoções' },
    { id: 'g9', src: 'assets/imgs/WhatsApp Image4 2026-08-15 at 13.47.19.jpeg', caption: '8 primeiras da progressiva espelhada ganham kit exclusivo', cat: 'Promoções' },
    { id: 'g10', src: 'assets/imgs/WhatsApp Image5 2026-08-15 at 13.47.19.jpeg', caption: 'Casa nova - agenda semanal', cat: 'Promoções' },
    { id: 'g7', src: 'assets/imgs/WhatsApp Image2 2026-08-15 at 13.47.19.jpeg', caption: 'Massoterapia e depilação - agenda de agosto aberta', cat: 'Massoterapia' },
    { id: 'g4', src: 'assets/imgs/WhatsApp Image 2026-08-12 at 22.22.11.jpeg', caption: 'Identidade visual do studio', cat: 'Marca' },
  ...
  wellness: {
    kicker: 'Massoterapia, Depilação & Bem-estar',
    contactWhatsapp: '559291265154',
    promoImage: 'assets/imgs/Captura de tela de 2026-08-15 14-44-32.png',
    promoAlt: 'Arte promocional da Massoterapia com Aline Barros',
    promoImages: [
      { src: 'assets/imgs/Captura de tela de 2026-08-15 14-44-32.png', alt: 'Arte promocional da Massoterapia com Aline Barros' },
    ...
    lede: 'Com Aline Maria, dentro do Angella Barros Studio de Beleza. Atendimentos de massoterapia e depilação com técnica, conforto e cuidado personalizado, em Parintins.',
    listKicker: 'Sessões',
  ...
  instagram: {
    ...
    feed: [
      { id: 'i1', src: 'assets/imgs/WhatsApp Image 2026-08-15 at 13.47.18.jpeg', caption: 'Agenda de agosto aberta. Garanta seu horário no WhatsApp.', likes: '1.382', comments: '94', type: 'photo', tags: ['#agendaaberta', '#parintins', '#angellabarros'] },
      { id: 'i2', src: 'assets/imgs/WhatsApp Image 2026-08-15 at 13.47.19.jpeg', caption: 'Procedimentos e valores atualizados para facilitar seu agendamento.', likes: '2.104', comments: '186', type: 'carousel', tags: ['#servicos', '#valores', '#studiodebeleza'] },
      { id: 'i3', src: 'assets/imgs/WhatsApp Image2 2026-08-15 at 13.47.19.jpeg', caption: 'Agenda de agosto aberta para massoterapia e depilação com atendimento personalizado.', likes: '1.211', comments: '73', type: 'photo', tags: ['#massoterapia', '#depilacao', '#alinebarros'] },
      { id: 'i4', src: 'assets/imgs/WhatsApp Image3 2026-08-15 at 13.47.19.jpeg', caption: 'Serviços a partir de R$ 100,00 e brinde surpresa para deixar esse momento ainda mais especial.', likes: '1.946', comments: '139', type: 'photo', tags: ['#casanova', '#promocao', '#angellabarrosstudio'] },
      { id: 'i5', src: 'assets/imgs/WhatsApp Image4 2026-08-15 at 13.47.19.jpeg', caption: 'As 8 primeiras clientes da progressiva espelhada garantem kit manutenção exclusivo.', likes: '2.337', comments: '214', type: 'photo', tags: ['#progressivaespelhada', '#kitmanutencao', '#cabelolindo'] },
      { id: 'i6', src: 'assets/imgs/WhatsApp Image5 2026-08-15 at 13.47.19.jpeg', caption: 'Semana com agenda aberta e ofertas especiais para celebrar a casa nova.', likes: '1.709', comments: '127', type: 'photo', tags: ['#agendaaberta', '#ofertas', '#parintinsam'] },
      { id: 'i7', src: 'assets/imgs/WhatsApp Image 2026-08-12 at 22.22.11.jpeg', caption: 'Assinatura visual oficial do studio de beleza.', likes: '863', comments: '42', type: 'photo', tags: ['#identidadevisual', '#marca', '#angellabarros'] },
    ],
  },
  settings: {
...
function prioritizeGallery(gallery = []) {
  const priority = ['g11', 'g12', 'g6', 'g5', 'g8', 'g9', 'g10', 'g7'];
...
function loadStore() {
  try {
    ...
    if (raw) {
      ...
      merged.gallery = prioritizeGallery(merged.gallery || DEFAULT_STATE.gallery);
      return merged;
    }
...
// A autenticação agora é por sessão com cookie httpOnly emitido em
// /api/admin/auth/login. O front só envia credentials e nunca guarda senha.
